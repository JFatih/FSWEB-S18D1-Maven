...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, COUNT(o.ogrno) FROM ogrenci AS o\n" +
    ...
    //--Ali: 2, Mehmet: 3
    String QUESTION_7 = "SELECT o.ad, COUNT(ad) FROM ogrenci AS o\n" +
            "GROUP BY o.ad";
    @Query(value = QUESTION_7, nativeQuery = true)
    List<StudentNameCount> findStudentNameCount();


    String QUESTION_8 = "SELECT o.sinif, COUNT(ogrno) FROM ogrenci AS o\n" +
            "GROUP BY o.sinif";
